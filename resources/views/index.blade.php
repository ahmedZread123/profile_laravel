...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="#">Ahmed<span>.</span></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav nav ml-auto">
					{{-- <li class="nav-item"><span>admin</span></a></li> --}}
				...
				<div class="container-fluid px-md-0">
					<div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
						...
						<div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
							<div class="text">
								<span class="subheading">Hello! This is Profile Ahmed</span>
								<h1 class="mb-4 mt-3">Creative <span>php</span> Laravel &amp; Developer</h1>
				...
				<div class="container-fluid px-md-0">
					<div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
						...
						<div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
							<div class="text">
								<span class="subheading">Hello! This is Profile Ahmed</span>
								<h1 class="mb-4 mt-3">Hi, I am <span>Ahmed</span> This is my favorite work.</h1>
								{{-- <p><a href="#" class="btn btn-primary">Hire me</a> <a href="#" class="btn btn-primary btn-outline-primary">Download CV</a></p> --}}
							</div>
						</div>
					</div>
						...
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								...
								<ul class="about-info mt-4 px-md-0 px-2">
									<li class="d-flex"><span>Name:</span> <span>Ahmed Zread </span></li>
									<li class="d-flex"><span>Date of birth:</span> <span>May 05, 2000</span></li>
									<li class="d-flex"><span>Address:</span> <span>Nuseirat Gaza, Palestine </span></li>
									{{-- <li class="d-flex"><span>Zip code:</span> <span>1000</span></li> --}}
									<li class="d-flex"><span>Email:</span> <span>yahmed9013@gmail.com</span></li>
									<li class="d-flex"><span>Phone: </span> <span>0594109389</span></li>
								</ul>
							</div>
		...
		@foreach ($skills as $item)
				...
				<div class="col-lg-4 mb-4">
					<div class="bg-white rounded-lg shadow p-4">
						<h2 class="h5 font-weight-bold text-center mb-4">{{$item->title}}</h2>

						<!-- Progress bar 1 -->
						<div class="progress mx-auto" data-value='{{$item->main_score}}'>
							...
							<div class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
								<div class="h2 font-weight-bold">{{$item->main_score}}<sup class="small">%</sup></div>
							</div>
						</div>
						<!-- END -->
						...
						<div class="row text-center mt-4">
							<div class="col-6 border-right">
								<div class="h4 font-weight-bold mb-0">{{$item->L_W_score}}%</div><span class="small text-gray">Last week</span>
							</div>
							<div class="col-6">
								<div class="h4 font-weight-bold mb-0">{{$item->L_M_score}}%</div><span class="small text-gray">Last month</span>
							</div>
						</div>
						<!-- END -->
					</div>
		...
		<div class="container-fluid px-md-4">
			...
			<div class="row">
				...
				<div class="col-md-3">
					...
					<div class="project img shadow ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/{{$item->image}});">
						<div class="overlay"></div>
						<div class="text text-center p-4">
							<h3>{{$item->title}}</h3>
							<span>{{$item->use_program}}</span>
						</div>
					</div></a>
				</div>
                @endforeach
	...
	<section class="ftco-section contact-section ftco-no-pb" id="contact-section">
		<div class="container">
			...
			<div class="row block-9">
				<div class="col-md-8">
					<form action="{{route('index-store')}}" method="POST" class="bg-light p-4 p-md-5 contact-form">
						@csrf
				...
				<div class="col-md-4 d-flex pl-md-5">
					<div class="row">
						<div class="dbox w-100 d-flex">
							...
							<div class="text">
								<p><span>Address:</span>	Nuseirat Gaza, Palestine
								</p>
							</div>
						</div>
						<div class="dbox w-100 d-flex">
							...
							<div class="text">
								<p><span>Phone:</span> <a href="tel://1234567920">	0594109389
								</a></p>
							</div>
						</div>
						<div class="dbox w-100 d-flex">
							...
							<div class="text">
								<p><span>Email:</span> <a href="mailto:info@yoursite.com">yahmed9013@gmail.com</a></p>
							</div>
						</div>
						{{-- <div class="dbox w-100 d-flex">
							<div class="icon d-flex align-items-center justify-content-center">
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2">I am pleased to visit you <i class="fa fa-heart" aria-hidden="true"></i></h2>
						{{-- <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						<p><a href="#" class="btn btn-primary">Learn more</a></p> --}}
						<a href="{{route('skills.index')}}" class="nav-link">	<button type="button" class="btn btn-outline-dark">Admin</button> </a>
					</div>
				</div>
				<div class="col-md">
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#services-section"><span class="fa fa-chevron-right mr-2"></span>{{$item->title}}</a></li>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon fa fa-map marker"></span><span class="text">Nuseirat Gaza, Palestine</span></li>
								<li><a href="#"><span class="icon fa fa-phone"></span><span class="text">0594109389</span></a></li>
								<li><a href="#"><span class="icon fa fa-paper-plane pr-4"></span><span class="text">yahmed9013@gmail.com</span></a></li>
							</ul>
						</div>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Ahmed</a>. 
